...
for rec in sortedList:
	...
	oai = doc.createElement('oai_dc:dc')
	...
	oai.setAttribute('xsi:schemaLocation','http://www.openarchives.org/OAI/2.0/oai_dc/ http://www.openarchives.org/OAI/2.0/oai_dc.xsd')
	...
	doc.childNodes[0].appendChild(oai)
